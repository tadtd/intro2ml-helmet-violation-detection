...
- Add documentation and local smoke-test tasks for any Docker Compose,
  Kubernetes, CI/CD, Supabase, Redis, API, or worker infrastructure change.
- Add secret-handling tasks for environment variables, Supabase service role
  keys, Kubernetes secrets, CI/CD secrets, certificates, or kubeconfigs.
- Add schema-ordering and non-destructive migration tasks for Supabase schema
  changes.
- Keep task paths inside the current repository structure; do not scaffold a new
  monorepo or parallel project.
...
- [ ] T010 Document local infrastructure run commands and smoke tests when infrastructure changes are included
- [ ] T011 Verify secret placeholders and environment variable handling for any Supabase, Kubernetes, or CI/CD changes
...
- [ ] TXXX [P] Update local runbook and smoke-test instructions for infrastructure changes
- [ ] TXXX Code cleanup and refactoring
- [ ] TXXX Performance optimization across all stories
- [ ] TXXX [P] Additional unit tests (if requested) in tests/unit/
- [ ] TXXX Security hardening
- [ ] TXXX Verify no real secrets, service role keys, kubeconfigs, certificates, private keys, or real `.env` files are committed
