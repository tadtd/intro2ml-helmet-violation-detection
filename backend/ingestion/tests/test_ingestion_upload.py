...
@patch("ingestion.src.main.jwt.decode")
def test_upload_video(mock_jwt, mock_send_task, mock_insert, mock_upload):
    # Mock authentication
    mock_jwt.return_value = {"sub": "user-123", "role": "operator"}
