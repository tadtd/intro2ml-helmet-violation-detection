...
from .base import Detection, ModelName, VALID_MODELS, validate_image
...
def get_detector(model_name: str):
    from .fasterrcnn_wrapper import FasterRcnnOnnxModel
    from .rtdetr_wrapper import RtDetrOnnxModel
    from .yolo_wrapper import YoloOnnxModel
